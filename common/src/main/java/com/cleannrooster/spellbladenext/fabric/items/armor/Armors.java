package com.cleannrooster.spellbladenext.fabric.items.armor;
            ...
            ArmorSetConfig.with(
                    new ArmorSetConfig.Piece(2)
                            .addAll(List.of(
                                   ...
                                   AttributeModifier.bonus(Identifier.of("extraspellattributes","reabsorption"), 1.5F)
                            )),
            ...
            ArmorSetConfig.with(
                    new ArmorSetConfig.Piece(2)
                            .addAll(List.of(
                                    ...
                                    AttributeModifier.bonus(Identifier.of("extraspellattributes","reabsorption"), 2.5F)
                            )),
                    new ArmorSetConfig.Piece(5)
                            .addAll(List.of(
                                    AttributeModifier.multiply(SpellSchools.ARCANE.id, 0.20F),
