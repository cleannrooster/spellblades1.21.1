...
public class DeathchillRenderer extends OrbitingEffectRenderer {
    private List<OrbitingEffectRenderer.Model> models;
    private float scale;
    private float horizontalOffset;
    private static final RenderLayer GLOWING_RENDER_LAYER;

    public DeathchillRenderer() {
        super(List.of(new OrbitingEffectRenderer.Model(GLOWING_RENDER_LAYER, 				Identifier.of(MOD_ID, "spell_projectile/orb")
        )), 1F, 1F);
        this.models =List.of( new OrbitingEffectRenderer.Model(GLOWING_RENDER_LAYER, 				Identifier.of(MOD_ID, "spell_projectile/orb")));
        this.scale = 0.3F;
    ...
    public void renderEffect(int amplifier, LivingEntity livingEntity, float delta, MatrixStack matrixStack, VertexConsumerProvider vertexConsumers, int light) {
        ...
        for(int i = 0; i < stacks; ++i) {
            ...
            this.renderModel(matrixStack, this.scale, verticalOffset, horizontalOffset+livingEntity.getWidth()/2, angle, itemRenderer, vertexConsumers, light, livingEntity);
        }
