...
public class DeathchillRenderer extends OrbitingEffectRenderer {
    ...
    public DeathchillRenderer() {
        super(List.of(new OrbitingEffectRenderer.Model(GLOWING_RENDER_LAYER, 				Identifier.of(MOD_ID, "projectile/orb")
        )), 1F, 1F);
        this.models =List.of( new OrbitingEffectRenderer.Model(GLOWING_RENDER_LAYER, 				Identifier.of(MOD_ID, "projectile/orb")));
        this.scale = 0.3F;
