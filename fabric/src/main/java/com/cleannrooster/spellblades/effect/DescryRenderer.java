...
public class DescryRenderer extends OrbitingEffectRenderer {
    private List<OrbitingEffectRenderer.Model> models;
    private float scale;
    private float horizontalOffset;
    private static final RenderLayer GLOWING_RENDER_LAYER;

    public DescryRenderer() {
        super(List.of(new OrbitingEffectRenderer.Model(GLOWING_RENDER_LAYER, 				Identifier.of(MOD_ID, "projectile/descry")
        )), 1F, 1F);
        this.models =List.of( new OrbitingEffectRenderer.Model(GLOWING_RENDER_LAYER, 				Identifier.of(MOD_ID, "projectile/descry")));
        this.scale = 0.5F;
        this.horizontalOffset = 0.75F;
    }
    static {
